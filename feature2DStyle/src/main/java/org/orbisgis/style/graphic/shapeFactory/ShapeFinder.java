...
/**
 * Get the shape from the a wellKnownNameParameter Look into a factory
 *
...
public class ShapeFinder {
    ...
    static {
        ...
        shapeFactories.put(WorldWeatherSymbolsFactory.FACTORY_PREFIX, new WorldWeatherSymbolsFactory());
    }
