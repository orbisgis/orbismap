...
public final class AxisChart extends Graphic implements IUom, FillNode,
        ...
        private double[] getMeasuresInPixel(Map<String,Object> map, IMapTransform mt) throws ParameterException {
        ...
        private void drawOrthoChart(Graphics2D g2, Map<String,Object> map,
                ...
                for (i = 0; i < nCat; i++) {
                        ...
                        if (c.getFill() != null || c.getStroke() != null) {
                                ...
                                if (c.getFill() != null) {
                                        c.getFill().draw(g2, map, shp, mt);
                                }
                                if (c.getStroke() != null) {
                                        c.getStroke().draw(g2, map, shp, mt, 0.0);
                                }
                        }
                }
                ...
                if (lineStroke != null) {
                        ...
                        lineStroke.draw(g2, map, shp,  mt, 0.0);
                }
                ...
                for (i = 0; i < nCat; i++) {
                        ...
                        if (c.getGraphicCollection() != null) {
                                ...
                                c.getGraphicCollection().draw(g2, map,  mt, at2);
                        }
                }
                ...
                RenderableGraphics rArrow = arrow.getRenderableGraphics(map,  mt);
        ...
        private void drawPolarChart(Graphics2D g2, Map<String,Object> map,
                ...
                for (i = 0; i < nCat; i++) {
                        ...
                        if (cat.getGraphicCollection() != null) {
                                ...
                                cat.getGraphicCollection().draw(g2, map,  mt, at2);
                        }
                        Shape shp;
                        ...
                        if (cat.getFill() != null || cat.getStroke() != null) {
                                ...
                                if (cat.getFill() != null) {
                                        cat.getFill().draw(g2, map, shp,  mt);
                                }
                                if (cat.getStroke() != null) {
                                        cat.getStroke().draw(g2, map, shp,  mt, 0.0);
                                }
                        }
        ...
        public void draw(Graphics2D g2, Map<String,Object> map,
                ...
                switch (subtype) {
                        case POLAR:
                                drawPolarChart(g2, map,  mt, at);
                                break;
                        case STACKED:
                                drawStackedChart(g2, map,  mt, at);
                                break;
                        case ORTHO:
                        default:
                                drawOrthoChart(g2, map,  mt, at);
                                break;
                }
        }

        private Rectangle2D getPolarBounds(Map<String,Object> map, IMapTransform mt) throws ParameterException, IOException {
        ...
        private Rectangle2D getStackedBounds(Map<String,Object> map, IMapTransform mt) throws ParameterException, IOException {
                double[] measuresInPixel = getMeasuresInPixel(map, mt);
                double sum = 0.0;
                for (double m : measuresInPixel) {
                        if (m < 0) {
        ...
        private Rectangle2D getOrthoBounds(Map<String,Object> map, IMapTransform mt) throws ParameterException, IOException {
                double[] measuresInPixel = getMeasuresInPixel(map, mt);
                double max = 0.0;
                for (double m : measuresInPixel) {
                        max += Math.abs(m);
