...
public final class ExternalGraphic extends Graphic implements IUom, TransformNode,
    ...
    public void draw(Graphics2D g2, Map<String,Object> map,
        ...
        if (halo != null) {
            // Draw it
            halo.draw(g2, map,  at.createTransformedShape(bounds), mt, false);
        }
    ...
    /*@Override
    public RenderableGraphics getRenderableGraphics(DataSet sds, long fid, boolean  IMapTransform mt) throws ParameterException, IOException {
    ...
    if (halo != null) {
    halo.draw(rg, map,  atShp, mt, false);
    ...
    /*public double getMargin(DataSet sds, long fid, IMapTransform mt) throws ParameterException, IOException {
    double delta = 0.0;
    ...
    /*
    @Override
    public double getMaxWidth(DataSet sds, long fid, IMapTransform mt) throws ParameterException, IOException {
    double delta = 0.0;
