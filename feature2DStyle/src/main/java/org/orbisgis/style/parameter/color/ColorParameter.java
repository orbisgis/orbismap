 ...
 */
public class ColorParameter extends StyleNode implements IParameterValue, Comparable{

    String expression ="#ffffff";
    private String identifier;
    
    public ColorParameter(String expression){
        this.expression =expression;
    }

    public ColorParameter(Color color) {
        this.expression = color.toString();
    }

    public ColorParameter() {
        this.expression = ColorHelper.toHex(ColorHelper.getRandomColor());
    }
    ...
    public int compareTo(Object t) {
        if (t instanceof ColorParameter) {
         ColorParameter exp = (ColorParameter) t;
