...
public final class DensityFill extends Fill implements GraphicNode {
    ...
    public void draw(Graphics2D g2, Map<String,Object> map, Shape shp, IMapTransform mt) throws ParameterException, IOException {
        ...
        if (isHatched) {
            ...
            HatchedFill.drawHatch(g2, map, shp, mt, alpha, pDist, hatches, 0.0);
        } else {

            Paint painter = getPaint(map, mt);
    ...
    public Paint getPaint(Map<String,Object> map, IMapTransform mt) throws ParameterException, IOException {
        ...
        if (percentage > ONE_HALF) {
            ...
            if (isHatched && hatches != null) {
                ...
                Rectangle2D bounds = mark.getBounds(map, mt);
                ...
                painter = GraphicFill.getPaint(map, mt, mark, gapX, gapY, bounds);
            } else {
