...
/**
 * Each implementation represent an affine transformation base on ParameterValue.
 * It means each transformation can depends on feature attributes 
 * or an expression
 *
 * @author Maxence Laurent
 */
public interface ITransform extends IStyleNode {
     ...
     */
    AffineTransform getAffineTransform(Uom uom, double dpi,
