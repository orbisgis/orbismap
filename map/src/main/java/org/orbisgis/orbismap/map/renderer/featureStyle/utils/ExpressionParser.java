...
public class ExpressionParser {
     ...
     * @throws JSQLParserException 
     */
    public static org.orbisgis.orbismap.style.parameter.Expression formatConditionalExpression(org.orbisgis.orbismap.style.parameter.Expression expression) throws JSQLParserException  {
        if(expression!=null){
          Expression expParsed = CCJSqlParserUtil.parseCondExpression(expression.getExpression(), false);     
          return new org.orbisgis.orbismap.style.parameter.Expression(expParsed.toString());
        }
        return new org.orbisgis.orbismap.style.parameter.Expression("");
     }
}
