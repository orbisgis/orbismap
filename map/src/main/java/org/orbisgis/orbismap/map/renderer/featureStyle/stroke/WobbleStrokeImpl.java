...
public class WobbleStrokeImpl implements Stroke {
    private BasicStroke basicStroke =null;
    private float detail = 2;
    private float amplitude = 2;
    private static final float FLATNESS = 1;

    public WobbleStrokeImpl(BasicStroke basicStroke,float detail, float amplitude) {
        this.basicStroke=basicStroke;
        this.detail	= detail;
        this.amplitude	= amplitude;
    }
    public WobbleStrokeImpl(BasicStroke basicStroke) {
        this.basicStroke=basicStroke;
        this.detail = (float) 1.0;
