 ...
 */
package org.orbisgis.coremap.renderer.featureStyle.label;
...
import org.orbisgis.coremap.renderer.featureStyle.ILabelDrawer;
    ...
    public void draw(JdbcSpatialTable sp, Graphics2D g2, MapTransform mapTransform, PointLabel styleNode, Map<String, Object> properties) throws ParameterException, SQLException {
        ...
        if (shape != null) {
            ...
            if (styleText != null) {
                ...
                Rectangle2D bounds = styleTextDrawer.getBounds(sp, g2, styleText.getText().getValue(properties), properties, mapTransform, styleText);
