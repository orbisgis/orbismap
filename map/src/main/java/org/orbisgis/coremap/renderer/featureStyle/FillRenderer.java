...
public class FillRenderer {
     ...
     */
    public static Paint getPaint(JdbcSpatialTable rs, SolidFill solidFill, IMapTransform mt) throws ParameterException, SQLException {
        ...
        if(colorIdenifier!=null && !colorIdenifier.isEmpty()){
         color = Color.decode(rs.getString(solidFill.getColor().getIdentifier()));
        }        
        if (color == null) {
    ...
    public static void drawSolidFill(JdbcSpatialTable rs, Graphics2D g2, SolidFill solidFill, Shape shp,
