    ...
    public static enum CategorizeMethod {
        ...
        public String toLocalizedString(){
            switch(this){
                ...
                case NATURAL_BREAKS: return "Natural breaks";
                case QUANTILES: return "Quantiles";
                case EQUAL_INTERVAL: return "Equal Intervals";
                case STANDARD_DEVIATION: return "Mean - Standard deviation";
                case BOXED_MEANS: return "Boxed means";
...
//            sortClasses();
    ...
    protected ToType getParameter(ResultSet rs, long fid) {
        try {
            ...
            LOGGER.warn("Unable to categorize the feature", ex);
        }
        return fallbackValue;
    }
