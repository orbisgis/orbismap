...
public abstract class SwingWorkerPM<T, V> extends SwingWorker<T, V> {
    ...
    private void setListeners() {
        progressMonitor.addPropertyChangeListener(IProgressMonitor.PROP_PROGRESSION, EventHandler.create
                (PropertyChangeListener.class, this, "onProgressMonitorChange"));
        progressMonitor.addPropertyChangeListener(IProgressMonitor.PROP_CANCEL, EventHandler.create
