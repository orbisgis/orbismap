...
/**
 * The IColor class allows the definition of color. As an abstract class and
 * part of the base of the core graphical concepts, this class is a global point
 * of extension for specifying concrete definitions of colors (e.g., RGBColor
 * extension).
 *
 * @author Ertz Olivier, HEIG-VD (2010-2020)
 * @author Erwan Bocher, CNRS (2010-2020)
 */
public interface IColor extends IStyleNode, IUom{
