...
/**
 * <code>Literal</code>s are the concrete realizations of <code>ValueParameter</code>.
 * While when using <code>ValueReference</code> objects, data will be retrieved
 * from a data source, <code>Literal</code>s will directly embed their datum.</p>
 ...
 * @author Bocher Erwan
 */
public abstract class Literal extends StyleNode implements IParameterValue, Comparable {
